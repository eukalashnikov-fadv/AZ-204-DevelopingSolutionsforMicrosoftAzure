...
namespace MessagePublisher
{
    public class Program
    {
        ...
        private const string serviceBusConnectionString = "Endpoint=sb://sbnamespaceek.servicebus.windows.net/;SharedAccessKeyName=RootManageSharedAccessKey;SharedAccessKey=emyIK69Uk/jnfNxiDEfk0Qty31UeRnCdj+ASbEEaODs=";
