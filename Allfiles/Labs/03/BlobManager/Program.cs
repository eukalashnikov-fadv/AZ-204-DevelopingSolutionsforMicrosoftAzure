...
public class Program
{
    ...
    private const string blobServiceEndpoint = "https://mediastorek.blob.core.windows.net/";

    //Update the storageAccountName value that you recorded previously in this lab.
    private const string storageAccountName = "mediastorek";

    //Update the storageAccountKey value that you recorded previously in this lab.
    private const string storageAccountKey = "WPV5vA63Q0m4JXdKz+AdHWiaMqPaLcGTzNoSNCerICc/a7XGW4OOyjvk2IBn08CwdpBfG9/krk40+ASt5VwyLA==";
